export const THEMES = {
    'emerald-dark': {
        ...
        name: 'System Default',
        isDark: true,
        backgroundClass: 'bg-gradient-to-br from-[#071713] via-[#0b1218] to-[#0b1720]',
    ...
    'emerald-light': {
        ...
        isDark: false,
        backgroundClass: 'bg-gradient-to-br from-[#f5faf8] via-[#f8fafc] to-[#f0f5f8]',
    ...
    'crimson-dark': {
        ...
        name: 'Crimson / Rose',
        isDark: true,
        backgroundClass: 'bg-gradient-to-br from-[#1b1019] via-[#13121c] to-[#1b1216]',
    ...
    'ocean-dark': {
        ...
        name: 'Ocean Blue',
        isDark: true,
        backgroundClass: 'bg-gradient-to-br from-[#0b1725] via-[#101422] to-[#171326]',
