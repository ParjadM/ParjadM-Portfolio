...
export const AboutSection = ({ theme }) => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center space-x-3">
                                <div className={`w-2 h-2 rounded-full ${accent.bgDot}`}></div>
    ...
    const borderColor = accent.borderSolid;
    ...
    return (
        <PageTransition className="min-h-screen flex items-center justify-center py-20 px-4">
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <GlassCard className="p-6 md:p-8 text-center" theme={theme}>
                            <div className={`w-48 h-48 mx-auto mb-6 rounded-full p-2 shadow-lg bg-gradient-to-br ${accent.gradientSoft}`}>
                                <img 
                                    src={ParjadImage}
                                    alt="Parjad Minooei" 
                                ...
                                {tabs.map(tab => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${
                                            activeTab === tab.id
                                                ? `${accent.bgOnly} text-white border-2 ${borderColor}`
                ...
                <Reveal>
                <div className={`mt-10 rounded-2xl p-[1.5px] bg-gradient-to-r ${accent.gradientPanel}`}>
