  ...
  return (
    <GlassCard className="p-8" theme={theme}>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-2xl font-bold text-white">AI Code Review</h3>
      ...
      <textarea
        ...
        rows={8}
        spellCheck={false}
        className="w-full font-mono text-sm bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-gray-200 placeholder-gray-600 focus:outline-none focus:border-white/30 resize-y"
      />
