...
import { Monitor, Newspaper, Film, Terminal, MessageSquare, Activity, ChevronDown, Sprout, BrainCircuit } from 'lucide-react';
...
export const Header = ({ setThemeId, currentThemeId, theme, darkMode = true, isMobileMenuOpen, setIsMobileMenuOpen, onLanguageChange }) => {
    ...
    const MORE_ITEMS = [
        ...
        { name: t('more.algoMem'), path: '/algorithm-memorizer', icon: <BrainCircuit className="w-4 h-4" />, description: t('more.algoMemDesc') },
